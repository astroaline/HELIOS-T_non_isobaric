...
priors = {"T": [2800, 100], "log_xh2o": [13,-13], "log_xch4": [13,-13], "log_xco": [13,-13], "log_kappa_cloud": [14,-12],
          ...
          "log_r_c": [6,-7], "log_p_cia": [3,-3], "Rstar": [rstar_uperr+rstar_loerr,rstar-rstar_loerr], "G": [2*g_uncertainty,g-g_uncertainty], "line": [5,0]} # priors for all possible parameters
...
opacity_path = os.environ['HOME'] + "/Desktop/PhD/DACE/"  # path to opacity binary files
