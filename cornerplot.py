...
def corner(xs, xfull, xbin, yfull, ybin, ydata, x_err, y_err, range2, line_color, color_list, bins=20, range=None, weights=None, color="k",
    ...
    **hist2d_kwargs
    ...
    if reverse:
        ...
        lbdim = 0.55 * factor   # size of left/bottom margin
    ...
    for i, x in enumerate(xs):
        ...
        ### Define sizes for corner plot ###
        frac = 2.5
        
        tick_label_size = (K + 40)/frac       # size of the parameter ticks (numbers)
        tick_size = (K + 8)/frac              # size of the ticks in each squared plot
        font_size = (54)/frac                 # size of the parameter labels
    ...
    ### Define sizes for spectrum ###
    label_size2 = (22*K/3 + 20)/frac         # size of labels
    label_pad = (4*K)/frac                   # size of space between labels and ticks
    text_size = label_size2 - 6              # size of legend
    tick_label_size2 = (7*K + 14)/frac
    tick_size2 = (4*K)/frac
    linethick = 1                            # size of model line (blue)
    symsize = 4
    symsize2 = 1 
    mew1 = (6*K/3)/frac
    msize = (3*K/3)/frac
