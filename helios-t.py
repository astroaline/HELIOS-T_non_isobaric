...
fig = cornerplot.corner(samples, x_full_plot, wavelength_centre, yfit, yfit_binned, ydata, wavelength_err, yerr, posterior_ranges, color_list,
                       labels=retrieved_parameter_labels, truths=plot_percentiles, max_n_ticks=3, label_kwargs={"fontsize": 40})
fig.savefig('cornerplot_' + planet_name + '_non_isobaric.png', format='png')
fig.savefig('cornerplot_' + planet_name + '_non_isobaric.eps', format='eps')
