...
def data(wavenumber=True):
    ...
    pressure_min, integral_grid, x_full = noniso.tau(parameter_dict["T"], 1e-6, p0)
    ...
    return x, x_full, integral_grid, bin_indices, ydata, yerr, wavelength_centre, wavelength_err
